...
MIN_BID_NEAREST_TICK = (
    (MINIMUM_BID + TICK_SIZE_IN_CENTS - 1) // TICK_SIZE_IN_CENTS * TICK_SIZE_IN_CENTS
)
MAX_ASK_NEAREST_TICK = MAXIMUM_ASK // TICK_SIZE_IN_CENTS * TICK_SIZE_IN_CENTS
...
class AutoTrader(BaseAutoTrader):
    ...
    def HP(self, r, theta, kappa, sigma, rho, S0, v0, T, N):
        dt = T / N
    ...
    def on_order_book_update_message(
        ...
        if instrument == Instrument.FUTURE:
            ...
            v0 = (
                0.01 * S0
            ) ** 2  # initial variance set to 1% of the initial asset price
            S, v = self.HP(
                r=0.05,
                theta=0.04,
                kappa=0.9,
